...
class ImageWatermark{
	...
	public $fontFile = 'shuiyin/arial.ttf';	//字体文件名
	public $color = '#000000';		//水印字体的颜色
	...
	private function getMarkPosition($type = 0) {
		switch($type){
			...
			case 2:
				...
				break;	//topcenter
			case 3:
				$x = $this->dest_width-$this->mark_width - 10;
				$y = 5;
				break;	// topright
			case 4:
				$x = 5;
			...
			case 7:
				$x = 5;
				$y = $this->dest_height-$this->mark_height - 10;
				break;	//bottomleft
			case 8:
				$x = ($this->dest_width-$this->mark_width) / 2;
				$y = $this->dest_height-$this->mark_height - 10;
			...
			case 9:
				...
				break;	//bottomright
			default:
				$x = rand(5, $this->dest_width-$this->mark_width);
				$y = rand(5, $this->dest_height-$this->mark_height);
				break;	//random
		}
		return array($x, $y);
	}
	...
	private function writeImage($ImageRes, $filename = null, $type = 0) {
		switch ($type) {
			...
			case 2: imagejpeg($ImageRes, $filename, 100);break;
