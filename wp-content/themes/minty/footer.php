...
?>
	...
	<footer id="footer" role="contentinfo" itemscope itemtype="http://schema.org/WPFooter">
		...
		<div class="copyright">
			&copy; <?php echo date('Y'); ?> <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></a> &middot; Powered by <a href="http://wordpress.org/" target="_blank" rel="generator">WordPress</a> &middot; Theme by <a href="http://c7sky.com/" target="_blank">小影</a><?php echo stripslashes(get_option('minty_footer_code'));
