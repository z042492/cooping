<?php get_header(); ?>
	...
	<div id="main">
		...
		<div class="loop">
			<div class="content">
				<a href="<?php the_permalink(); ?>" title="<?php the_title();?>"><?php post_thumbnail(array(340,180)); ?></a>
				
			</div>
			<h2><a href="<?php the_permalink(); ?>" title="<?php the_title();?>"><?php echo mb_strimwidth(strip_tags(get_the_title()), 0, 38,"..."); ?> </a></h2>
